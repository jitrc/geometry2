...
public:
  ...
  *  @param q The Quaternion to match */
  ...
  void setRotation(const Quaternion & q)
  {
    ...
    setValue(
      tf2Scalar(1.0) - (yy + zz), xy - wz, xz + wy,
  ...
  **/
  ...
  {
    setValue(
      tf2Scalar(1.0), tf2Scalar(0.0), tf2Scalar(0.0),
  ...
  * @param roll around X axis */
    ...
    unsigned int solution_number = 1) const
  {
    ...
    if (tf2Fabs(m_el[2].x()) >= 1) {
      ...
      euler_out.roll = tf2Atan2(
        m_el[2].y() / tf2Cos(euler_out.pitch),
        m_el[2].z() / tf2Cos(euler_out.pitch));
      euler_out2.roll = tf2Atan2(
        m_el[2].y() / tf2Cos(euler_out2.pitch),
        m_el[2].z() / tf2Cos(euler_out2.pitch));

      euler_out.yaw = tf2Atan2(
        m_el[1].x() / tf2Cos(euler_out.pitch),
        m_el[0].x() / tf2Cos(euler_out.pitch));
      euler_out2.yaw = tf2Atan2(
        m_el[1].x() / tf2Cos(euler_out2.pitch),
